...
<head>
    ...
    <style>
        ...
        *::after {
        ...
        .feature-orange .feature-icon-wrap {
        ...
        .feature-card:hover .feature-bg-deco {
            opacity: 0.09;
    ...
    <nav>
        <div class="nav-inner">
            ...
            <ul class="nav-links">
                ...
                <li><a href="/diagnostic.php">🔬 Diagnostic IA</a></li>
                <?php if (isset($_SESSION['user_id'])): ?>
                    <li><a href="/profil.php">👤 <?= htmlspecialchars($_SESSION['user_nom']) ?></a></li>
                    <li><a href="/deconnexion.php" class="nav-cta">🚪 Déconnexion</a></li>
                <?php else: ?>
