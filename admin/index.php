    ...
    <style>
        *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .sidebar-section {
            ...
            color: rgba(255,255,255,0.3); padding: 0 1.5rem; margin: 1rem 0 0.5rem; display: block;
        }
        .sidebar-link {
            display: flex; align-items: center; gap: 10px; padding: 0.7rem 1.5rem;
            color: rgba(255,255,255,0.65); text-decoration: none; font-size: 0.9rem;
            transition: all 0.2s; border-left: 3px solid transparent;
        }
        .sidebar-link:hover, .sidebar-link.active {
            color: #fff; background: rgba(255,255,255,0.06); border-left-color: var(--green-light);
        }
        ...
        /* MAIN CONTENT */
        .main { margin-left: var(--sidebar-w); flex: 1; padding: 2rem; width: 100%; }
        ...
        .stat-card { background: var(--white); border-radius: 16px; padding: 1.5rem; box-shadow: 0 2px 12px rgba(0,0,0,0.05); display: flex; align-items: center; gap: 1rem; }
        ...
        .stat-number { font-family: 'Playfair Display', serif; font-size: 1.8rem; font-weight: 900; }
        ...
        .btn-add { background: var(--green); color: #fff; text-decoration: none; font-size: 0.8rem; padding: 0.5rem 1rem; border-radius: 20px; font-weight: 600; }
        ...
        .badge { font-size: 0.7rem; font-weight: 700; padding: 0.25rem 0.6rem; border-radius: 20px; display: inline-flex; align-items: center; gap: 4px; }
        ...
        .btn-edit { color: var(--green); text-decoration: none; font-weight: 600; font-size: 0.8rem; padding: 0.3rem 0.7rem; background: #e8f5ee; border-radius: 8px; }
        ...
        @media (max-width: 768px) {
            ...
            th:nth-child(2), td:nth-child(2), /* Région */
...
<main class="main">
    ...
    <div class="stats-grid">
        <div class="stat-card">
            ...
            <div><div class="stat-number"><?= $total_cultures ?></div><div class="stat-label">Cultures</div></div>
        </div>
        <div class="stat-card">
            <div class="stat-icon" style="background: #e8f0fe;">📈</div>
            <div><div class="stat-number"><?= $total_prix ?></div><div class="stat-label">Prix suivis</div></div>
        </div>
        <div class="stat-card">
            <div class="stat-icon" style="background: #e8f5ee;">↑</div>
            <div><div class="stat-number" style="color: #2d9e5f;"><?= $hausses ?></div><div class="stat-label">Hausses</div></div>
        </div>
        <div class="stat-card">
            <div class="stat-icon" style="background: #fef3e8;">↓</div>
            <div><div class="stat-number" style="color: #e05c1a;"><?= $baisses ?></div><div class="stat-label">Baisses</div></div>
        </div>
    </div>
